...
// wawatech
router.get('/wawatech/news-xinhui', require('./routes/0wawatech/news-xinhui'));

// mlog
router.get('/mlog', require('./routes/mlog'));

// mlog
router.get('/mlog/:id', require('./routes/mlog/user'));
...
router.get('/jinritoutiao/user', require('./routes/jinritoutiao/user'));
